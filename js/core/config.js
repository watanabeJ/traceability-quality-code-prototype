...
const portalEntries = {
  ops: { label: "运营方后台", shortLabel: "运营端", path: "pages/ops/orders.html" },
...
const products = [
  { id: 1, name: "云岭高山绿茶", company: "云岭生态农业有限公司", category: "农产品", batch: "YL20260718", status: "待审核", submitted: "2026-07-26 16:42", amount: 10000 },
...
const messages = [
  ...
  { type: "生成完成", title: "订单 ORD-202607-031 二维码已生成", detail: "压缩包共包含 50,000 张二维码图片。", time: "昨天", unread: false },
];
