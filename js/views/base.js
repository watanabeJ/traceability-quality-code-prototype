...
function qrStepContent() {
  ...
  if (state.qrStep === 2) return `<div class="form-grid"><div class="field full"><label class="required">尺寸</label><div class="qr-size-inputs"><input type="number" min="8" max="300" step="0.1" value="25" aria-label="尺寸宽度，单位毫米"><span aria-hidden="true">×</span><input type="number" min="8" max="300" step="0.1" value="25" aria-label="尺寸高度，单位毫米"><span>mm</span></div></div></div>`;
